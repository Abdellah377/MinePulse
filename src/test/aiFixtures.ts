...
export const result: InvestigationResult = {
  ...
  conclusion: { summary: "Conclusion enregistrée du backend : preuve insuffisante.", diagnosis_status: "INCONCLUSIVE", root_cause: null, reliable_root_cause: false, observed_fact_evidence_ids: [], derived_metric_evidence_ids: [], supported_hypothesis_ids: [], unresolved_uncertainties: ["Objectif de poste indisponible."], confidence: "LOW" },
